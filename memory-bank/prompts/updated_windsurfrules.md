...
1. `project-background.md` - Core project information and context that doesn't change frequently
2. `high-level-plan.md` - Overall project roadmap, milestones, and success metrics
3. `detailed-plan.md` - Detailed plan for the current implementation focus
4. `scratchpad.md` - Shared collaborative space for notes and temporary information
...
1. A private GitHub repository is used for version control
2. Environment variables are stored in .env (gitignored) with .env.example as a template
3. A comprehensive README.md is maintained with setup and usage instructions
4. Standard Python project structure with src/, tests/, and docs/ directories

I understand that adherence to these rules and proper use of the memory bank is essential for maintaining consistent context and providing effective assistance throughout this project.
